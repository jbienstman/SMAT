...
.NOTES
    #######################################################################################################################################
    # Author: Jim B.
    # Latest version can be found on Github: https://github.com/jbienstman/SMAT/ReportPermissionAllWebsInFarm.ps1
    #######################################################################################################################################
    # Revision(s)
    ...
    #######################################################################################################################################
.SYNOPSIS
    This script will iterate through all webs in all sites and report the Role Assignments using the custom function "Get-spWebRoleAssignments"
